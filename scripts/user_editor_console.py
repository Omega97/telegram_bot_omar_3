...
class UserEditor:
    ...
    def cmd_help(*_):
        ...
        print("\n AVAILABLE COMMANDS:")
        print("  help, h, ?          - ℹ️ Show this help message")
